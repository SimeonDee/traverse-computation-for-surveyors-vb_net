Public Class FrmProgram
    ...
    Private Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        If Not (IsNothing(txtmin.Text)) And Not (IsNumeric(txtmin.Text)) Then
            MessageBox.Show("Only a numeric value is allowed")
            txtmin.SelectAll()
            txtmin.Focus()
            Exit Sub
        ...
        If Not (IsNothing(txtSec.Text)) And Not (IsNumeric(txtSec.Text)) Then
            MessageBox.Show("Only a numeric value is allowed")
            txtSec.SelectAll()
            txtSec.Focus()
            Exit Sub
        ...
        If txtDeg.Text <> "" And txtmin.Text = "" And txtSec.Text = "" Then
            bearing = CSng(txtDeg.Text)
        ElseIf txtDeg.Text <> "" And txtmin.Text <> "" And txtSec.Text = "" Then
            bearing = CInt(txtDeg.Text) + (CSng(txtmin.Text) / 60)
        Else
